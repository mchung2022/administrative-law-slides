...
print("=== Generating Full 13,000+ Character Dual-Host Script (Exact 30:00 Broadcast) ===")
...
chapters = [
    {
        ...
        "lines": [
            ...
            {"speaker": "阿哲", "voice": "zh-TW-YunJheNeural", "text": "小晨老師，很多學生一聽到行政法就覺得條文高深莫測。像我常常在新聞看到高鐵採購、政府標案，或是公立醫院掛號、路面坑洞傷人，這些到底算公法還是私法啊？阿哲我自己平常逛街看新聞，也常搞混呢！"},
    ...
    },
    {
        ...
        "lines": [
            ...
            {"speaker": "阿哲", "voice": "zh-TW-YunJheNeural", "text": "這對保障國民權益真的是太重要了！國會親自立法保障人權，才是法治國真正的精髓！"},
    ...
    },
    {
        ...
        "lines": [
            ...
            {"speaker": "小晨", "voice": "zh-TW-HsiaoChenNeural", "text": "不客氣！法律是維護權利與自由的武器。希望各位同學在聽完這集 30 分鐘特企廣播後，能輕鬆融會貫通！祝大家大考高分奪標，《行政法 500 頁旗艦總複習》Podcast，我們下次見！"},
...
print(f"[OK] Saved Full 13,000+ Character Dual-Host Script JSON to {script_json_path}")
