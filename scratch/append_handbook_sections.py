...
print("=== Appending Detailed 10-Chapter Content to build_50page_master_handbook.py ===")

script_path = os.path.join(os.path.dirname(__file__), 'build_50page_master_handbook.py')
...
print("[OK] Successfully appended sections to build_50page_master_handbook.py!")
