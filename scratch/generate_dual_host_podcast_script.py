...
print("=== Generating Expanded 30-Minute Dual-Host Podcast Script (8,800+ Chars) ===")
...
chapters = [
    {
        ...
        "lines": [
            {"speaker": "阿哲", "voice": "zh-TW-YunJheNeural", "text": "哈囉！各位同學、法學愛好者與各大考試的考生們，大家辛苦了！歡迎收聽《行政法 500 頁旗艦總複習——30 分鐘特企 Podcast 廣播對談講堂》！我是主持人阿哲。"},
            ...
            {"speaker": "阿哲", "voice": "zh-TW-YunJheNeural", "text": "小晨老師，很多學生一聽到行政法就覺得條文高深莫測，光是看高鐵採購、政府標案、或是路面坑洞傷人，就搞不清楚這到底算公法還是私法。"},
            ...
            {"speaker": "小晨", "voice": "zh-TW-HsiaoChenNeural", "text": "絕對不行！現代國家從過去干涉的警察國家，轉型為照顧生活的給付行政與服務性國家。即使是授益行政，也必須嚴格遵守依法行政原則與公平分配！好，把握住第一單元的直覺，我們接著看第二單元！"}
        ]
    },
    {
        "id": 2,
    ...
    },
    {
        ...
        "lines": [
            ...
            {"speaker": "阿哲", "voice": "zh-TW-YunJheNeural", "text": "太充實了！感謝小晨老師這 30 分鐘帶我們通盤貫通行政法十大模組！"},
...
print(f"[OK] Saved 30-Minute Dual-Host Script JSON to {script_json_path}")
