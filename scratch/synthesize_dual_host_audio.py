...
print("=== Synthesizing Dual-Host (YunJhe & HsiaoChen) Audio (Rate=-35% for Exact 30-Min Pacing) ===")

json_path = os.path.join(os.path.dirname(__file__), 'podcast_script_30min.json')
output_dir = os.path.join(os.path.dirname(__file__), 'ch_audio_dual_exact30')
