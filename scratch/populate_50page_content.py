...
print("=== Writing Massive 50-Page Tutorial Content ===")

script_path = os.path.join(os.path.dirname(__file__), 'build_massive_50page_handbook.py')
...
print("[OK] Successfully appended massive content to build_massive_50page_handbook.py!")
