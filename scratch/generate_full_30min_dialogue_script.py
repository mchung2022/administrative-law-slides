...
print("=== Generating Full 8,800+ Character Dual-Host Podcast Script (Exact 30-Min Broadcast) ===")
...
chapters = [
    {
        ...
        "lines": [
            ...
            {"speaker": "阿哲", "voice": "zh-TW-YunJheNeural", "text": "小晨老師，很多學生一聽到行政法就覺得條文高深莫測，光是看高鐵採購、政府標案、或是路面坑洞傷人，就搞不清楚這到底算公法還是私法。阿哲我自己平常逛街看新聞，也常搞混呢！"},
            ...
            {"speaker": "小晨", "voice": "zh-TW-HsiaoChenNeural", "text": "成文法以憲法為至高頂點，下方依次為立法院三讀之法律、行政機關發布之法規命令與地方自治條例！不成文法源則包含習慣法與一般法律原則。好，把握住第一單元的直覺，我們接著看第二單元！"}
        ]
    },
    {
        "id": 2,
...
print(f"[OK] Saved 8,800+ Character Dual-Host Script JSON to {script_json_path}")
