...
print("=== Building Full 40+ Page Enterprise Handbook with Prompts & Charts ===")
...
add_subtitle("108 課綱公民與社會：行政法核心概念大型專案協作教學手冊 (40+ 頁企業精裝版)")
...
add_bullet("【指定實測 rate=-15% (4.22 字/秒)】：防範 edge-tts 預設語速過快或設定過慢（-50%）導致失真，以實測數據導向確定最舒適的成年人對談語速。", bold_prefix="解說 1（語速精準控制）：")
...
add_bullet("TTS 連線逾時 (NoAudioReceived)：在 Python 加入 try...except 重視循環與 asyncio.sleep(0.3) 緩衝。", bold_prefix="QA 1：")
